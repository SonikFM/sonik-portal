  ...
  return (
    <>
      ...
      <div className="px-4 md:px-8">
        ...
        <div className="flex flex-wrap gap-0 gap-y-6 md:gap-6 md:flex-nowrap">
          <div className="w-full px-4 py-5 border md:w-4/6 border-grey-light rounded-2xl">
          ...
          <div className="w-full border md:w-4/12 border-grey-light rounded-2xl">
            asd
          </div>
        </div>
      </div>

...
const ArtistTime = ({ className, ...rest }) => {
  return (
    <div className={cn("flex gap-3 items-center py-4", className)} {...rest}>
      ...
      <div className="h-10 rounded-[10px] text-sm px-3 py-2.5 bg-grey-dark text-grey-100 w-2/3 ">
        Daniel Sams{" "}
      </div>
      <div className="h-10 rounded-[10px] text-sm px-3 py-2.5 bg-grey-dark text-grey-100 w-1/3  flex gap-2">
        {" "}
        <TimerIcon /> Daniel Sams{" "}
      </div>

...
export const columns = [
	...
	{
		accessorKey: "organizer",
		header: ({ table }) => <div className="text-sm capitalize">Phone Number</div>,
		cell: ({ row }) => (
			<div className="flex items-center w-32 gap-3 text-sm">{row.original.phone}</div>
		),
		enableSorting: true,
		enableHiding: false,
	},
		...
		cell: ({ row }) => {
			return (
				<div className="flex items-center gap-3 w-44">
					<h3 className="font-medium truncate shrink">{row.original.venue.location}</h3>
				</div>
			);
		},
	},

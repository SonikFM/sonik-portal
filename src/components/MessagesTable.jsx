        ...
        <div className="flex flex-col w-full gap-4">
          <Tabs defaultValue="messages" className="w-full ">
            <TabsList className="flex justify-around w-full p-1 rounded-lg bg-grey-200 h-9">
              ...
              <TabsTrigger className="rounded-md h" value="messages">
                Messages
              </TabsTrigger>
              ...
              {[1, 2, 3].map((item, index) => {
                return (
                  <div
                    key={`new-tab-${item}`}
                    className={cn(
                      "flex items-center justify-between gap-3 py-3  hover:bg-grey-light/60",
          ...
          <Button variant="outline" className="w-full gap-2 h-9">
            {" "}
            <EditIcon className="text-grey-100" /> New Message{" "}
          </Button>
        </div>
      </CardContent>
    </Card>
